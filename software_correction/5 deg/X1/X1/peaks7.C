...
///////////load a file//////////////////
   ...
   c1->Divide(1,2);
   c1->cd(1);
   TFile *f = new TFile("run6043+6044_test22.root");
   TH1F *h1 = (TH1F*)f->Get("h165");
   h1->Draw("");
////////////////////////////////////////
   ...
   Int_t nfound = s->Search(h1,0,"",0.15);// change the last number to fit more peaks.
